...
module Homebrew
  ...
  class FormulaAuditor
    ...
    def audit_specs
      ...
      resources_allowlist = formula.tap&.audit_exception(:pypi_resources_allowlist, formula.name)
      allowed_pypi_packages = Set.new(resources_allowlist.present? ? resources_allowlist.split(/\s+/i) : [])
